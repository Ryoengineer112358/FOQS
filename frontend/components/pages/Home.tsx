          ...
          {questions.map((x, index) => (
            ...
            >
              <CardMessage
                text={(() => {
                  if (
                    x.tutor_answers.length == 0 &&
                    x.student_comments.length == 0
                  ) {
                    return x.text
                    ...
                    return x.tutor_answers[0].created_at >
                      x.student_comments[0].created_at
                      ? x.tutor_answers[0].text
                      : x.student_comments[0].text
                  }
                })()}
            ...
            >
              <Grid item xs={8} sm={6} md={4}>
                ...
                >
                  <LinkButton
                    text='質問を見つける'
                    href='tutor/unassigned-questions'
                  />
                </motion.div>
              </Grid>
            </Grid>
