                ...
                <>
                  ...
                  <Box sx={{ marginTop: '0.8rem' }}>
                    <TextField
                      ...
                      InputProps={{
                        endAdornment: (
                          <InputAdornment position='end'>高校</InputAdornment>
                        ),
                      }}
                      required
                      sx={{ width: '100%' }}
                  ...
                  <Box sx={{ marginTop: '0.8rem' }}>
                    <TextField
                      ...
                      label='第一志望大学'
                      onChange={(event) =>
                        setFirstChoiceUniversity(event.target.value)
                      }
                      InputProps={{
                        endAdornment: (
                          <InputAdornment position='end'>大学</InputAdornment>
                        ),
                      }}
                      required
                      sx={{ width: '100%' }}
                    ...
                    />
                    <FormHelperText error>
                      {errors.first_choice_university?.[0]}
                    </FormHelperText>
                  </Box>
                  ...
                  <Box sx={{ marginTop: '0.8rem' }}>
                    <TextField
                      ...
                      label='第一志望学部'
                      onChange={(event) =>
                        setFirstChoiceFaculty(event.target.value)
                      }
                      InputProps={{
                        endAdornment: (
                          <InputAdornment position='end'>学部</InputAdornment>
                        ),
                      }}
                      required
                      sx={{ width: '100%' }}
