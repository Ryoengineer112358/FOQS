    ...
    if (isReady) {
      axios
        ...
        .then((response) => {
          ...
          if (
            questionData.tutor_id === null &&
            questionData.closed_at === null
          ) {
            ...
            <Grid item xs={12} sm={10} md={8}>
              <QuestionContent
                ...
                first_choice_university={
                  question?.student!.first_choice_university || ''
                }
                first_choice_faculty={
                  question?.student!.first_choice_faculty || ''
                }
              />
            </Grid>
          </Grid>
          <Grid container justifyContent='center' marginTop={3}>
            <Grid item xs={8} sm={6} md={4}>
              <ModalButton
                ...
                clickHandler={() => {
                  axios
                    .put<StudentQuestion>(`/api/questions/${question.id}`)
                    .then(() => {
                      router.push('/tutor')
                    })
                    .catch((error) => {
